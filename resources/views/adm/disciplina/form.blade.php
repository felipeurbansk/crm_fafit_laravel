	...
	<div class="span12">
		<div class="widget">
            ...
            <div class="controls">
              ...
              <div class="controls">
                  <input type="text" class="span1" name="semestres" id="semestres" value="@isset($disciplina){{$disciplina->semestres}}@else{{old('semestres')}}@endisset"/>
									<br>
				 ...
				 <div class="control-group @if($errors->has('ch')) 'error' @endif ">
							 ...
							 <div class="controls">
									 <input type="text" class="span1" name="ch" id="ch" value="@isset($disciplina){{$disciplina->ch}}@else{{old('ch')}}@endisset"/>
									 <br>
