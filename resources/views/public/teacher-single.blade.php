            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-title-box">
                        <h2>teacher <span>Single</span> </h2>
                        <p><a href="index-one.html">Home</a> / <a href="#">teachers</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-7 col-sm-7">
                    <div class="teacher-single-col">
                        <div class="teacher-biography">
                            <ul>
                                <li><strong>Teacher Name : </strong> Merry Alvina</li>
                                <li><strong>Teach : </strong> Accounting</li>
                                <li><strong>experience : </strong> 5 years</li>
                                <li><strong>educational qualification :</strong> BBA & MBA (Form Oxford University)</li>
                                ...
                                <li><strong>Phone Numbar : </strong> +0123 0142 0144 1122</li>
                                <li><strong>Mail Address : </strong> yourmail@gmail.com</li>
                            </ul>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="teachers-col">
                        ...
                        <h4><a href="teacher-single.html">Merry Alvina</a></h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="teachers-col">
