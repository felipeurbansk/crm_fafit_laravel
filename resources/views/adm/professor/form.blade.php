	...
	<div class="span12">
		<div class="widget">
			...
			<div class="widget-body">
				...
				<form action="@isset($professor) {{route('adm.professor.atualizar')}} @else {{route('adm.professor.cadastro')}} @endisset" method="post" class="form-horizontal" enctype="multipart/form-data" >
				{{csrf_field()}}
				@isset($professor)
